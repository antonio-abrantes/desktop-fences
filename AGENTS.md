...
1. A etapa vigente está em `docs/SESSION-HEADER.md` e o detalhe operacional em `docs/plano-implementacao.md`. O MVP 1, o MVP 2 (Fases 1–2) e as Fases 3–4 estão fechados. A Fase 5 está no código (gate Windows 11 pendente). A Fase 6 é a custódia transacional dos itens do Desktop; a Fase 7 é o instalador. Duplo clique no desktop, packs de tema e empurrar vizinhos **não** entram neste ciclo.
